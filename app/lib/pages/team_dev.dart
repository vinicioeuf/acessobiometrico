        ...
        body: Center(
          child: ListView(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10),
              buildTeamMember('assets/imagens/viniEufrazio.jpg', 'Vinicio Eufrazio', 'Desenvolvedor Backend', 'Desenvolvedor back-end, Técnico em Informática (IFSertãoPE), Graduando em Tecnologia em Sistemas para Internet (IFSertãoPE), Administrador de sites na K1Digital.'),
            ],
          ),
        ),
      );
